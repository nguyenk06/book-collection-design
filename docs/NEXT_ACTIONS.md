...
- **Next owners:** `ENGINEER — SEI` may accept the read-only assessment after explicit `!run`; Product Owner separately retains held validation items and the final conclusion.
