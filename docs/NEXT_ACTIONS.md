...
- **Current gate:** Publication/version change for exact `115b1a57` requires separate Product Owner authorization. If later published, rerun the updated [Version 26 Scanner Product Owner Review](VERSION_26_SCANNER_OWNER_REVIEW.md) against the new exact public version. Broader visual acceptance remains held; no application/Site action or protected-system change is authorized now.
