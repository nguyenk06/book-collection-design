...
| --- | --- | --- |
| My Library visual experience | Partial | Version 21 passed all release gates, but its publication result is ambiguous and supported metadata cannot recover the missing deployment identity; evidence-standard decision pending |
