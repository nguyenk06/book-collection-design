...
Sei returned a read-only source-informed A–H estimate against exact Version 20 source. Phase A and the static Phase D foundation at `608553f`, plus older combined remediation at `80e4c61`, remain historical evidence without recoverable editable source. The Version 20-based correction candidate is complete, locally validated, source-preserved, saved, and definitively published as Version 21 at `f15ea8144ec277a737f5e491e0276b60555cafb8`. Controlled publication Attempt 2 returned a deployment identity and `succeeded` status. After propagation, all five authorized anonymous public markers matched.

## Authoritative snapshot

- **Released Site:** Exact Version 21 at source checkpoint `f15ea8144ec277a737f5e491e0276b60555cafb8`. Controlled publication Attempt 2 returned an opaque deployment identity, production URL, publish type, and definitive `succeeded` status. The earlier ambiguous invocation remains historical evidence only.
- **Latest saved Site:** Version 21 at exact source checkpoint `f15ea8144ec277a737f5e491e0276b60555cafb8`; its saved build archive reports 47 files. No preview is active. Saved and released identities now agree.
...
- **Engineer state:** `SEI II — RETIRED`; `SEI III — VERSION 21 RELEASE COMPLETE / DRAINED`.
...
- **Planner decisions:** One decision is pending: authorize a refreshed bounded Version 21 Product Owner hands-on checklist, or keep validation parked. The visible release marker remains deferred.
- **Active owner:** `PLANNER — QUATRE` — process Decision 1 in [`PLANNER_INBOX.md`](PLANNER_INBOX.md).
- **Blocking owner:** `PRODUCT OWNER` through Quatre for the next hands-on validation gate. No Engineer brief is active.
...
The final prepublication reading was `!32:35`; ending usage was not refreshed. The release brief is complete, so no additional estimate is active. Obtain a fresh reading before any later Engineer slice. The 15% five-hour floor and separate longer-period check remain in force.
...
| Shopping UI | Published in exact Version 21 | Definitive deployment success; anonymous mobile Shopping marker matches | Product Owner hands-on checkpoint remains separately gated |
| M3 canonical identifiers | Published in exact Version 21 | Focused/full tests and prior Version 20 publication evidence remain valid; candidate source unchanged outside three files | Product Owner checkpoint remains separately gated |
| M4 bounded Bookshelf | Published in exact Version 21 | Bookcase, Shelf alternate, missing-position detail, and cover-fallback markers match anonymously | Product Owner checkpoint remains gated; transport acceptance remains unverifiable |
| M5 catalog export foundation | Published in exact Version 21 | Format v1, stable Book IDs, referential validation, deterministic output, no-write proof, and candidate validation passed | Complete backup/restore is not established |
| M6 downloadable export UI | Published in exact Version 21 | 8/8 focused and cumulative publication suites, build, owner gating, no-write checks, and collision separation passed | Product Owner checkpoint remains separately gated |
...
| Confirmed validation-failure remediation | Published in exact Version 21 | Build/package/boundaries passed; controlled Attempt 2 succeeded; all five anonymous markers match | Product Owner hands-on validation remains separately gated |
...
| Shopping | Published in exact Version 21; anonymous mobile navigation marker matches; hands-on validation gated |
| Scanner | Existing scanning works; M3 canonical identifier foundation is complete locally |
| Bookshelf | Published in exact Version 21; four Bookcase/Shelf/detail/cover markers match; hands-on checkpoint gated |
...
Exact Version 21 at `f15ea81` is now definitively published after all authorized build/package/boundary gates and one successful controlled Attempt 2. All five anonymous public markers match. Quatre must now route the separate Product Owner hands-on validation decision; the release marker, broad smoke, mutations, corrections, and later release operations remain closed.
