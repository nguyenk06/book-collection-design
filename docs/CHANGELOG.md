...
- Product Owner approved M2 Gate 3 only: starting usage 80%, cumulative allowance 30 percentage points, hard stop at 50% remaining, one guarded additive activation invocation, preserve the immediate response, and stop before Gate 4 regardless of outcome. Remaining allowance after the Gate 3 report may be used only for a factual M4 acceptance/transport report from existing evidence. No verification, correction, retry, Shopping save/publication, live checklist, smoke test, restore, rollback, or destructive action is authorized.
