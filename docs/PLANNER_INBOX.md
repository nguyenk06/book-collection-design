...
No Planner decisions currently pending. Product Owner selected Decision 1:A on 2026-08-31, authorizing one transport-layer isolation run for the Sites-managed source path. The accepted brief's diagnostic addendum records the credential, metadata, direct-query, failure-attribution, support-evidence, preservation, and conditional-save boundaries.
