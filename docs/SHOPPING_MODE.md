...
- Run the authorized bounded public-content fingerprint assessment as behavior-level evidence only after authoritative release metadata proved unavailable; retry and source changes remain unauthorized.
