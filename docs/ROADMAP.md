...
| 3 | [Bookshelf](BOOKSHELF.md) | Planned; bounded first-release brief queued and eligible | Accepted M3 convergence; later user checkpoint before activation | Medium | Shelf view and mobile shelf-scroll behavior absent |
| 4 | [Import and Export](IMPORT_EXPORT.md) | Partial; export-first brief queued but blocked | M4 completion and Designer-approved external-ID/export-scope contract | Medium-large | Import writes immediately; no export or backup infrastructure |
