...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; exact cumulative Version 20 published; confirmed mobile/Bookshelf corrections saved as Version 21; future Shopkeeper redesign documented | Run the prepared diagnostic-only classification, then separately gate remediation or publication resume | Medium-large | Publication attempts remain zero; live validation, smoke, correction, and recovery remain gated |
