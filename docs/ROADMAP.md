...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; Version 21 public behavior mismatches four markers; controlled republish stopped before tests under unsupported Node 18 | Decide existing supported Node 22.13+ alignment or park | Medium-large | New publication invocation remains unused; installation, dependency/config changes, further retry, live validation, smoke, correction, and recovery remain gated |
