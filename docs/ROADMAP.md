...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; Version 21 passed release gates, but public behavior mismatches four of five candidate markers and exact identity is unavailable | Decide one controlled exact-candidate republish or park | Medium-large | Prior attempt consumed; retry, live validation, smoke, correction, and recovery remain gated |
