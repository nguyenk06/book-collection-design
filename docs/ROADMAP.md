...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; Version 21 passed release gates, publication result is ambiguous, and authoritative identity lookup is unavailable | Decide behavior-level fingerprinting versus parking | Medium-large | Attempt 1/1 consumed; retry, live validation, smoke, correction, and recovery remain gated |
