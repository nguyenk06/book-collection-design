...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; focused 17/17 passes under Node 24, but fresh full-suite summary was unattributable | Decide two-run full-suite attribution, retained evidence acceptance, or park | Medium-large | Publication Attempt 2 remains unused; source/dependency/config changes, further retry, live validation, smoke, correction, and recovery remain gated |
