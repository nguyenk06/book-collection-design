...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; Version 20 published; corrections saved as Version 21; diagnostic reruns passed 17/17 and 3/3 | Decide whether to authorize publication-resume revalidation | Medium-large | Publication attempts remain zero; live validation, smoke, correction, and recovery remain gated |
