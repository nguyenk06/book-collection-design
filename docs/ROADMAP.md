...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; Version 21 passed release gates but its sole publication result is ambiguous | Reconcile exact live deployment identity read-only | Medium-large | Attempt 1/1 consumed; retry, live validation, smoke, correction, and recovery remain gated |
