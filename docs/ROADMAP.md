...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; Version 21 passed release gates, but public behavior mismatches four of five candidate markers and exact identity is unavailable | Run the one controlled exact-candidate republish brief | Medium-large | A second invocation is explicitly authorized only after full gates; further retry, live validation, smoke, correction, and recovery remain gated |
