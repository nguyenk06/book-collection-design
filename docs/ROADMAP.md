...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; exact cumulative Version 20 published; confirmed mobile/Bookshelf corrections saved as Version 21; future Shopkeeper redesign documented | Bounded Version 21 publication, then conditional Product Owner live validation | Medium-large | Publication is authorized but unrun; smoke, correction, and recovery remain closed |
