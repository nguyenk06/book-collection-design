...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; Version 21 public behavior mismatches four markers; supported-Node resume authorized | Run the supported-Node republish-resume brief | Medium-large | Publication Attempt 2 remains unused; installation, dependency/config changes, further retry, live validation, smoke, correction, and recovery remain gated |
