...
| 4 | [Import and Export](IMPORT_EXPORT.md) | Partial; export-first brief blocked | Designer-approved external-ID/export-scope contract and adequate reserve | Medium-large | Import writes immediately; no export or backup infrastructure |
