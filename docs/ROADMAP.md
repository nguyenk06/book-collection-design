...
| 1 | [Shopkeeper / historical Shopping Mode](SHOPPING_MODE.md) | Partial; Node 24 runtime/identity/lint passed, but focused-suite result was unattributable | Run bounded diagnosis with conditional release continuation | Medium-large | Publication Attempt 2 remains unused; source/dependency/config changes, further retry, live validation, smoke, correction, and recovery remain gated |
