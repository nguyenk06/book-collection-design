...
4. Reconcile current state, next action/owner, pending Planner decisions, and active transport artifacts. Surface missing sources or conflicts; do not resolve them silently.
5. Report: Role: DESIGNER; documentation loaded; current project state; Planner decision count; inbox count; brief count; current milestone; NEXT OWNER; and documentation conflicts or missing sources.
