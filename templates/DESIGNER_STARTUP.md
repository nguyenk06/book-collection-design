...
4. Reconcile current state, active workstreams and progress, active/blocking owners, pending Planner decisions, and active transport artifacts. Surface missing sources or conflicts; do not resolve them silently.
5. Report: Role: DESIGNER; documentation loaded; current project state; current workstreams; Planner decision count; inbox count; brief count; current milestone; active/blocking owners; and documentation conflicts or missing sources.
